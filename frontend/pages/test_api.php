...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .textarea-wrap textarea{width:100%;background:var(--bg2);border:2px solid var(--brd);border-radius:var(--radius);padding:13px 16px 13px 44px;color:var(--text);font-size:.95rem;font-family:inherit;resize:none;outline:none;transition:border-color .3s;min-height:48px;max-height:140px}
        [dir=rtl] .textarea-wrap textarea{padding:13px 44px 13px 16px}
        .textarea-wrap textarea:focus{border-color:var(--accent)}
        .textarea-wrap textarea::placeholder{color:var(--text3)}
        .attach-btns{position:absolute;bottom:11px;left:10px;display:flex;gap:4px}
        [dir=rtl] .attach-btns{left:auto;right:10px}
        .attach-btn{width:32px;height:32px;border-radius:8px;border:none;background:var(--card2);color:var(--text3);cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:.9rem;transition:all .2s}
        .attach-btn:hover{background:var(--accent);color:#fff}
        input[type="file"]{display:none}
        .send-btn{background:var(--accent-g);border:none;width:48px;height:48px;border-radius:var(--radius);cursor:pointer;display:flex;align-items:center;justify-content:center;color:#fff;font-size:1.2rem;transition:transform .15s,box-shadow .15s;flex-shrink:0}
