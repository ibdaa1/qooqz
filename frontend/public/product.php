...
/* Add to cart — stores in localStorage under 'pub_cart' */
function pubAddToCart(btn) {
    var qty   = parseInt(document.getElementById('pubQtyInput').value, 10) || 1;
    ...
    if (!found) {
        cart.push({ id: id, name: name, price: price, qty: qty, image: img, currency: cur });
    }
