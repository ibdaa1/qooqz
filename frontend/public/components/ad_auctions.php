    ...
    <a href="<?= e($aHref) ?>"
       ...
       style="text-decoration:none;<?= e($_cardAuction) ?>">
        ...
        <div class="pub-product-card-body">
            <?php if ($aFeatured): ?>
                <span class="pub-product-badge"><?= e(t('auctions.featured', 'مميّز')) ?></span>
            <?php endif; ?>
