...
final class CertificatesCorrectionsController
{
    private CertificatesCorrectionsService $service;

    public function __construct(CertificatesCorrectionsService $service)
    {
