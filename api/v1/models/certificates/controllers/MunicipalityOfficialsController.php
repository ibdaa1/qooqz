...
final class MunicipalityOfficialsController
{
    private MunicipalityOfficialsService $service;

    public function __construct(MunicipalityOfficialsService $service)
    {
