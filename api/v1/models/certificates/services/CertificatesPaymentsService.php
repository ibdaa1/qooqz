...
final class CertificatesPaymentsService
{
    private PdoCertificatesPaymentsRepository $repo;
    private CertificatesPaymentsValidator $validator;

    public function __construct(
        PdoCertificatesPaymentsRepository $repo,
        CertificatesPaymentsValidator $validator
    ) {
        $this->repo = $repo;
    ...
    public function delete(int $tenantId, int $id): void
    {
        if (!$this->repo->delete($tenantId, $id)) {
            throw new RuntimeException('Failed to delete payment record.');
        }
    }
}