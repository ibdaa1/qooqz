...
final class CertificatesRequestItemsTranslationsService
{
    private PdoCertificatesRequestItemsTranslationsRepository $repo;
    private CertificatesRequestItemsTranslationsValidator $validator;

    public function __construct(
        PdoCertificatesRequestItemsTranslationsRepository $repo,
        CertificatesRequestItemsTranslationsValidator $validator
    ) {
        $this->repo = $repo;
