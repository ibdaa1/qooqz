...
<head>
    <meta charset="UTF-8">
    <title>شهادة صحية - دول مجلس التعاون</title>
    <style>
        ...
        .section-title { font-weight: bold; background: #f0f0f0; padding: 5px 10px; margin: 20px 0 10px; border-right: 5px solid #333; }
...
<body>
    <div class="cert-container">
        <div class="header">
            ...
            <h3>دول مجلس التعاون الخليجي (GCC)</h3>
        </div>
