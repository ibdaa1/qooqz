<?php
/**
 * Template: English Non-GCC Certificate
 * Version: en_non_gcc
 */
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title>Health Certificate - Non-GCC Countries</title>
    <style>
        ...
        .section-title { font-weight: bold; background: #eee; padding: 5px 10px; margin: 20px 0 10px; border-left: 5px solid #444; }
