...
(function () {
    ...
    // Call init() only after BOTH translations (for THIS fragment) and the
    // Tickets module are ready.  Guard on i18nApplied so stale
    // window.TRANSLATIONS from a previously-loaded fragment never triggers init.
    function tryInit() {
    ...
    // Fallback poll: handles the edge case where admin:i18n:applied already fired
    // before this listener was registered, and covers late-loading JS files.
