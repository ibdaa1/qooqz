 ...
 * Corrected: removed source_country_id (not in table), all 21 columns mapped.
 */
                ...
                <fieldset class="form-section">
                    ...
                    <div style="display:flex;gap:8px;align-items:center;margin-bottom:12px;flex-wrap:wrap;">
                        <select id="productSelectorForAdd" class="form-control" style="min-width:260px;flex:1;max-width:420px;">
                            <option value="" data-i18n="form.items.select_product">Select product to add...</option>
                        </select>
                    ...
                    <div style="overflow-x:auto;">
                        <table id="itemsTable" style="width:100%;border-collapse:collapse;font-size:12px;min-width:860px;">
                            ...
                            <tbody id="itemsTableBody">
                                <tr id="itemsEmptyRow">
                                    <td colspan="11" style="text-align:center;color:#94a3b8;padding:28px;font-style:italic;" data-i18n="form.items.empty">
                    ...
                    <table class="data-table" id="requestsTable">
                        <thead>
                            <tr>
                                ...
                                <?php if (is_super_admin()): ?><th data-i18n="table.headers.tenant">Tenant</th><?php endif; ?>
...
(function(){
    ...
    const iv=setInterval(()=>{
        if(window.AdminFramework&&window.CertificatesRequests?.init){
            clearInterval(iv); window.CertificatesRequests.init().catch(console.error);
        }else if(++t>80){clearInterval(iv);console.error('CertificatesRequests timeout');}
    },100);
})();
</script>
<?php else: ?>
