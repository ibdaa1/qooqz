...
.dash-card {
    background: var(--background_secondary, #1e293b);
    border: 1px solid var(--border_color, #334155);
    border-radius: 12px;
    padding: 2rem;
    margin-bottom: 2rem;
}
.dash-title { font-size: 2rem; font-weight: 700; color: var(--text_primary,#fff); margin-bottom:0.5rem; }
.dash-subtitle { color: var(--text_secondary,#94a3b8); font-size:0.9375rem; margin-bottom:0; }
...
.welcome-content p { margin:0; color:var(--text_secondary,#94a3b8); }
...
.color-card {
    background: var(--background_secondary,#1e293b);
    border:2px solid var(--border_color,#334155);
    border-radius:10px;
    padding:1rem;
    cursor:pointer;
    transition:all 0.2s ease;
}
.color-card:hover { border-color: var(--primary_color,#6366f1); transform:translateY(-4px); box-shadow:0 8px 20px rgba(0,0,0,0.3); }
...
.color-name { font-weight:600; color:var(--text_primary,#fff); margin-bottom:0.5rem; font-size:0.95rem; }
.color-code { font-family:'Courier New', monospace; font-size:0.85rem; color:var(--text_secondary,#94a3b8); background:rgba(0,0,0,0.2); padding:0.25rem 0.5rem; border-radius:4px; }
...
.empty-state { text-align:center; padding:3rem; color:var(--text_secondary,#94a3b8); }
...
<div class="dashboard-wrapper">
    ...
    <!-- Quick Actions -->
    <div class="dash-card">
        <h2 style="font-size:1.5rem; margin-bottom:0.5rem; color:var(--text_primary);" data-i18n="quick_actions_title">Quick Actions</h2>
    ...
    <!-- Theme Colors -->
    <div class="dash-card">
        <h2 style="font-size:1.5rem; margin-bottom:0.5rem; color:var(--text_primary);" data-i18n="theme_preview_title">Active Theme Colors</h2>
