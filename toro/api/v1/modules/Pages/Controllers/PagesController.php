<?php
/**
 * TORO — v1/modules/Pages/Controllers/PagesController.php
 */
...
final class PagesController
{
    ...
    public function __construct()
    {
        ...
        $this->service = new PagesService(new PdoPagesRepository($pdo));
    }
    ...
    public function showBySlug(array $params = []): void
    {
        $slug = $params['slug'] ?? '';
        $lang = $_GET['lang']  ?? null;
        Response::json(['success' => true, 'data' => $this->service->getBySlug($slug, $lang)], 200);
    }
    ...
    {
        $data = $this->json();
        PagesValidator::create($data);
        $result = $this->service->create(CreatePageDTO::fromArray($data), $this->authUserId());
    ...
    public function update(array $params = []): void
    {
        $id   = (int)($params['id'] ?? 0);
        $data = $this->json();
        PagesValidator::update($data);
        $result = $this->service->update($id, UpdatePageDTO::fromArray($data), $this->authUserId());
    ...
    public function destroy(array $params = []): void
    {
        ...
        Response::json(['success' => true, 'message' => 'تم حذف الصفحة'], 200);
    }
